...
// Language is a lowercase 2 letter ISO 639 code, country is uppercase 2-3 letter ISO 3166 code, same as QLocale
auto systemLocale = std::locale("")
auto engLocale = std::locale("en_US")
auto cLocale = std::locale::classic()
std::locale::global(systemLocale) // Returns previous set locale, sets locale used for default locale constructor
