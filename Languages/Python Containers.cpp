...
l = []
l = ["One", "Two", "Three"]
l = range(2, 6) /*or*/ [2, 3, 4, 5]
del l[1] // delete member at index 1
...
t = ("One", "Two", "Three")
(a, b, c) = t
t.count("One") // number of times value is in
t.index("One") // get index of leftmost occurance of value or throw ValueError
...
d = {}
d = {"One":8806336, "Two":6784346, "Three":1122345}
del d["One"]
d["One"] = 1234567
