...
• Penetration vector is shortest vector from origin to surface of Minkowski Difference hull
• For the simplex, find the face that is closest to the origin
    - Find the point along that direction that is the furthest away (+ largest dot product)
    - If there is none, the penetration depth is the normal
    - If there is one, add the point to the simplex to turn the single face into three faces
